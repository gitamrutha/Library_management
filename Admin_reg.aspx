<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_reg.aspx.cs" Inherits="Library_management.User_reg" %>
    ...
    <form id="form1" class="f1" runat="server">
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="TextBox6" ErrorMessage="Invalid Password"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
