...
{
    public partial class User_reg1 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string ins = "insert into User_tab values(" + Reg_id + ",'" + TextBox1.Text + "','" + TextBox3.Text + "','" + TextBox5.Text + "','" + ch + "','" + TextBox6.Text + "','" + TextBox2.Text + "','" + TextBox4.Text + "','" + r + "','" + img + "')";
                int i = obj.Fun_exenonquery(ins);
                String inslog = "insert into Log_tab values(" + Reg_id + ",'User','" + TextBox7.Text + "','" + TextBox8.Text + "','Active')";
